...
"""
データ定義モジュール
学生・現場代表社員・リクルーターのダミーデータ生成に必要な定数を格納します。
"""

NUM_STUDENTS = 50
NUM_EMPLOYEES = 5
NUM_RECRUITERS = 5
ASSIGNMENT_DIFFERENCE = 10 # 担当学生の上限加減の差

# --- データ定義 (定数) ---
SURNAMES = ['サトウ', 'スズキ', 'タカハシ', 'タナカ', 'ワタナベ', 'イトウ', 'ナカムラ', 'コバヤシ', 'ヤマモト', 'カトウ', 'ヨシダ', 'ヤマダ', 'ササキ', 'ヤマグチ', 'サイトウ']
MALE_NAMES = ['タロウ', 'ジロウ', 'ケンタ', 'ヒロシ', 'ツバサ', 'ダイスケ', 'マナブ', 'ユウキ', 'アキラ', 'タカシ']
FEMALE_NAMES = ['ハナコ', 'ユミ', 'サクラ', 'アヤカ', 'ミサキ', 'ユイ', 'マユミ', 'サトミ', 'カナ', 'アオイ']
...
UNIVERSITY_MAP = {  # 茨城大学と宇都宮大学を追加する必要あり
    '秋田大学': {
        '理系': {
            '国際資源学部': ['国際資源学科'],
            '医学部': ['医学科', '保健学科'],
...
GENDERS = ['男性', '女性']
APPLICANT_CATEGORIES = ['学部', '院']
PERSONALITY_TYPES = ['結果重視タイプ', '調和重視タイプ', '秩序重視タイプ', '創造重視タイプ']
RESULTS = ['合格', '不合格']
WORK_LOCATIONS = ['東日本', '西日本']
CORPORATE_DEPARTMENTS = ['営業本部', '開発本部', 'ソリューション事業本部', '人事本部', 'コーポレート本部', '技術統括本部']
